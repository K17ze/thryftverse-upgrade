...
export const LOOK_TEMPLATES: CreatorTemplate[] = [
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.85, height: 0.85, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
      ])],
  ...
  },
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.4, height: 0.4, x: 0.3, y: 0.3, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('media'), 2), type: 'media', width: 0.4, height: 0.4, x: 0.7, y: 0.3, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('media'), 3), type: 'media', width: 0.4, height: 0.4, x: 0.5, y: 0.7, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
      ])],
  ...
  },
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('product'), 1), type: 'product', width: 0.3, height: 0.15, x: 0.3, y: 0.25, payload: { listingId: '', snapshotTitle: 'Item 1', snapshotPriceGbp: 0, availability: 'available' } },
        { ...baseLayer(createStableId('product'), 2), type: 'product', width: 0.3, height: 0.15, x: 0.7, y: 0.25, payload: { listingId: '', snapshotTitle: 'Item 2', snapshotPriceGbp: 0, availability: 'available' } },
        { ...baseLayer(createStableId('product'), 3), type: 'product', width: 0.3, height: 0.15, x: 0.3, y: 0.5, payload: { listingId: '', snapshotTitle: 'Item 3', snapshotPriceGbp: 0, availability: 'available' } },
        { ...baseLayer(createStableId('product'), 4), type: 'product', width: 0.3, height: 0.15, x: 0.7, y: 0.5, payload: { listingId: '', snapshotTitle: 'Item 4', snapshotPriceGbp: 0, availability: 'available' } },
      ])],
  ...
  },
  {
    ...
    build: () => ({
      ...
      canvas: { aspectRatio: 0.75, background: { type: 'color', value: '#1a1a1a' } },
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.9, height: 0.7, y: 0.4, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('text'), 2), type: 'text', width: 0.8, height: 0.1, y: 0.85, payload: { text: 'EDITORIAL', textStyle: 'headline', textColor: '#ffffff', alignment: 'center' } },
      ])],
  ...
  },
  {
    ...
    build: () => ({
      ...
      pages: [page([
        ...
        { ...baseLayer(createStableId('text'), 3), type: 'text', width: 0.6, height: 0.08, y: 0.9, payload: { text: 'Colour Story', textStyle: 'editorial', textColor: '#ffffff', alignment: 'center' } },
      ])],
...
export const POSTER_TEMPLATES: CreatorTemplate[] = [
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.9, height: 0.6, y: 0.35, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('text'), 2), type: 'text', width: 0.8, height: 0.1, y: 0.8, payload: { text: 'New Drop', textStyle: 'headline', textColor: '#ffffff', alignment: 'center' } },
      ], 5000)],
  ...
  },
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.85, height: 0.55, y: 0.3, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('product'), 2), type: 'product', width: 0.6, height: 0.12, y: 0.75, payload: { listingId: '', snapshotTitle: 'Featured Item', snapshotPriceGbp: 49, availability: 'available' } },
      ], 5000)],
  ...
  },
  {
    ...
    build: () => ({
      ...
      pages: [page([
        { ...baseLayer(createStableId('text'), 1), type: 'text', width: 0.8, height: 0.08, y: 0.15, payload: { text: 'Which style?', textStyle: 'headline', textColor: '#ffffff', alignment: 'center' } },
  ...
  },
  {
    ...
    build: () => ({
      ...
      canvas: { aspectRatio: 0.5625, background: { type: 'color', value: '#1a1a1a' } },
      pages: [page([
        { ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.8, height: 0.5, y: 0.3, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } },
        { ...baseLayer(createStableId('text'), 2), type: 'text', width: 0.7, height: 0.08, y: 0.7, payload: { text: 'Just Listed', textStyle: 'compact', textColor: '#ffffff', alignment: 'center' } },
        { ...baseLayer(createStableId('product'), 3), type: 'product', width: 0.5, height: 0.1, y: 0.85, payload: { listingId: '', snapshotTitle: 'New Item', snapshotPriceGbp: 29, availability: 'available' } },
      ], 5000)],
  ...
  },
  {
    ...
    build: () => ({
      ...
      canvas: { aspectRatio: 0.5625, background: { type: 'color', value: '#0d0d0d' } },
      pages: [
        page([{ ...baseLayer(createStableId('media'), 1), type: 'media', width: 0.9, height: 0.7, y: 0.4, payload: { mediaUri: '', mediaType: 'image', contentFit: 'cover' } }], 3000),
        page([{ ...baseLayer(createStableId('text'), 1), type: 'text', width: 0.8, height: 0.1, payload: { text: 'Behind the Scenes', textStyle: 'editorial', textColor: '#ffffff', alignment: 'center' } }], 3000),
      ],
