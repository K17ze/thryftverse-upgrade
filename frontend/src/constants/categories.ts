...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'home-care', name: 'Household care', icon: 'water-outline', hasChildren: true },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'elec-beauty', name: 'Beauty & personal care electronics', icon: 'body-outline', hasChildren: true },
      { id: 'elec-wearables', name: 'Wearables', icon: 'watch-outline', hasChildren: true },
      { id: 'elec-other', name: 'Other devices & accessories', icon: 'desktop-outline', hasChildren: true },
    ],
  },
  {
    id: 'entertainment',
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'spt-outdoor', name: 'Outdoor sports', icon: 'trail-sign-outline', hasChildren: true },
      ...
      { id: 'spt-boxing', name: 'Boxing & martial arts', icon: 'hand-left-outline', hasChildren: true },
